...
jQuery.fn.setFacebookLike=function(a){a=jQuery.extend(!0,{},jQuery.multiSocialService.facebook.like,a);if(a.lang==="en")a.lang="locale=en_US&";a.ogp.app_id&&$("head").append("<meta property='fb:app_id' content='"+a.ogp.app_id+"' />");a="<iframe src='http://www.facebook.com/plugins/like.php?"+a.lang+"app_id="+a.ogp.app_id+"&href="+encodeURIComponent(jQuery.multiSocialService.url)+"&amp;layout="+a.type+"&amp;show_faces="+a.show_faces+"&amp;width=450&amp;action=like&amp;font&amp;colorscheme="+a.color+
"&amp;height=21' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:"+a.width+"px; height:"+a.height+"px;' allowTransparency='true'></iframe>";$(this).html(a);return this};
