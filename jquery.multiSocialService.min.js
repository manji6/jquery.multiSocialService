...
jQuery.fn.setFacebookLike=function(a){a=jQuery.extend(!0,{},jQuery.multiSocialService.facebook.like,a);if("en"===a.lang)a.lang="locale=en_US&";if(void 0!==$("meta").filter(function(){return"fb:app_id"===$(this).attr("property")}).attr("content"))a.ogp.app_id=$("meta").filter(function(){return"fb:app_id"===$(this).attr("property")}).attr("content");if(a.ogp.app_id){$("head").append("<meta property='fb:app_id' content='"+a.ogp.app_id+"' />");var b;b='<div id="fb-root"></div><script>(function(d, s, id) {  var js, fjs = d.getElementsByTagName(s)[0];  if (d.getElementById(id)) {return;}  js = d.createElement(s); js.id = id;'+('  js.src = "//connect.facebook.net/ja_JP/all.js#xfbml=1&appId='+
a.ogp.app_id+'";');$("body").append(b+'  fjs.parentNode.insertBefore(js, fjs);}(document, "script", "facebook-jssdk"));<\/script>');$("html").attr("xmlns:fb","http://ogp.me/ns/fb#");b=""+('<fb:like href="'+encodeURIComponent(jQuery.multiSocialService.url)+'"');b+='send="'+a.send+'"';b+='layout="'+a.type+'"';b+='width="'+a.width+'"';b+='show_faces="'+a.show_faces+'"';$(this).html(b+"></fb:like>")}else a="<iframe src='http://www.facebook.com/plugins/like.php?"+a.lang+"app_id="+a.ogp.app_id+"&href="+
encodeURIComponent(jQuery.multiSocialService.url)+"&amp;layout="+a.type+"&amp;show_faces="+a.show_faces+"&amp;width=450&amp;action=like&amp;font&amp;colorscheme="+a.color+"&amp;height=21' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:"+a.width+"px; height:"+a.height+"px;' allowTransparency='true'></iframe>",$(this).html(a);return this};
jQuery.fn.setFacebookComments=function(a){a=jQuery.extend(!0,{},jQuery.multiSocialService.facebook.comments,a);if(void 0!==$("meta").filter(function(){return"fb:app_id"===$(this).attr("property")}).attr("content"))a.app_id=$("meta").filter(function(){return"fb:app_id"===$(this).attr("property")}).attr("content");if(!a.app_id)return!1;var b;b='<div id="fb-root"></div><script>(function(d, s, id) {  var js, fjs = d.getElementsByTagName(s)[0];  if (d.getElementById(id)) {return;}  js = d.createElement(s); js.id = id;'+
...
jQuery.fn.setGooglePlus1=function(a){var a=jQuery.extend(!0,{},jQuery.multiSocialService.google.plus1,a),b;b=""+('<script type="text/javascript" src="https://apis.google.com/js/plusone.js" charset="utf-8">{lang: "'+a.lang+'"}<\/script>');b+='<g:plusone size="'+a.size+'" count="'+a.count+'" href="'+jQuery.multiSocialService.url+'" callback="'+a.callback+'"></g:plusone>';$(this).html(b);return this};jQuery.setOGP=function(a){jQuery.extend(!0,{},{title:document.title},a);$("head").append(aHtmlOGP)};
jQuery.fn.setTumblr=function(a){a=jQuery.multiSocialService.initialize(jQuery.extend(!0,{},jQuery.multiSocialService.tumblr,a));a.href=jQuery.multiSocialService.url;var b={};switch(a.setType){case "link":a.url&&(b.url=a.url),a.name&&(b.name=a.title),a.description&&(b.description=a.description)}a='<script type="text/javascript" src="http://platform.tumblr.com/v1/share.js"><\/script>'+('<a href="http://www.tumblr.com/share/link?'+jQuery.param(b)+'" title="Share on Tumblr" style="display:inline-block; text-indent:-9999px; overflow:hidden; width:81px; height:20px; background:url(\'http://platform.tumblr.com/v1/share_1.png\') top left no-repeat transparent;">');
$(this).html(a+"Share on Tumblr</a>");return this};function encodeURIComponentRFC3986(a){return encodeURIComponent(a).replace(/[!*'()]/g,function(a){return"%"+a.charCodeAt(0).toString(16)})};
