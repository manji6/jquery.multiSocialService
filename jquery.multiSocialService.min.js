...
jQuery.fn.setFacebookLike=function(a){a=jQuery.extend(true,{},jQuery.multiSocialService.facebook.like,a);if(a.lang==="en")a.lang="locale=en_US&";if(a.ogp.app_id){$("head").append("<meta property='fb:app_id' content='"+a.ogp.app_id+"' />");var b=[];b.push('<div id="fb-root"></div>');b.push("<script>(function(d, s, id) {");b.push("  var js, fjs = d.getElementsByTagName(s)[0];");b.push("  if (d.getElementById(id)) {return;}");b.push("  js = d.createElement(s); js.id = id;");b.push('  js.src = "//connect.facebook.net/ja_JP/all.js#xfbml=1&appId='+
a.ogp.app_id+'";');b.push("  fjs.parentNode.insertBefore(js, fjs);");b.push('}(document, "script", "facebook-jssdk"));<\/script>');$("body").append(b.join(""));$("html").attr("xmlns:fb","http://ogp.me/ns/fb#");b=[];b.push('<fb:like href="'+encodeURIComponent(jQuery.multiSocialService.url)+'"');b.push('send="'+a.send+'"');b.push('layout="'+a.type+'"');b.push('width="'+a.width+'"');b.push('show_faces="'+a.show_faces+'"');b.push("></fb:like>");$(this).html(b.join(" "))}else a="<iframe src='http://www.facebook.com/plugins/like.php?"+
a.lang+"app_id="+a.ogp.app_id+"&href="+encodeURIComponent(jQuery.multiSocialService.url)+"&amp;layout="+a.type+"&amp;show_faces="+a.show_faces+"&amp;width=450&amp;action=like&amp;font&amp;colorscheme="+a.color+"&amp;height=21' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:"+a.width+"px; height:"+a.height+"px;' allowTransparency='true'></iframe>",$(this).html(a);return this};
jQuery.fn.setFacebookComments=function(a){a=jQuery.extend(true,{},jQuery.multiSocialService.facebook.comments,a);if(!a.app_id)return false;var b=[];b.push('<div id="fb-root"></div>');b.push("<script>(function(d, s, id) {");b.push("  var js, fjs = d.getElementsByTagName(s)[0];");b.push("  if (d.getElementById(id)) {return;}");b.push("  js = d.createElement(s); js.id = id;");b.push('  js.src = "//connect.facebook.net/ja_JP/all.js#xfbml=1&appId='+a.app_id+'";');b.push("  fjs.parentNode.insertBefore(js, fjs);");
b.push('}(document, "script", "facebook-jssdk"));<\/script>');$("body").append(b.join(""));$("html").attr("xmlns:fb","http://ogp.me/ns/fb#");b=[];b.push('<fb:comments href="'+encodeURIComponent(jQuery.multiSocialService.url)+'"');b.push('num_posts="'+a.num_posts+'"');b.push('width="'+a.width+'"');b.push("></fb:comments>");$(this).html(b.join(" "));return this};
